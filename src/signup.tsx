      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="backdrop-blur-lg bg-black/30 p-8 rounded-2xl w-full max-w-md hover:shadow-glow transition-all duration-500 border border-white/10 shadow-xl">
          <div className="text-center mb-8 relative">
            <h1 className="text-5xl font-bold text-gradient mb-3 animate-gradient tracking-tight">Debug Smarter</h1>
            <p className="text-gray-300 text-lg font-light tracking-wide">Unleash the Power of AI</p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-800">
            <p className="text-xs text-center text-gray-500">
              ...
              <a href="#" className="hover-link text-purple-400 hover:text-purple-300">Terms of Service</a>
              {' '}and{' '}
              <a href="#" className="hover-link text-purple-400 hover:text-purple-300">Privacy Policy</a>
            </p>
          </div>
        </div>
      </div>
